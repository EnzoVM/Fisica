...
public class Caida_Objeto extends javax.swing.JDialog {
    public static String nom;
    public static HiloObjeto ho;
    Caida_libre c = null;
    FondoPanel fondo = new FondoPanel();
    
    public Caida_Objeto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        nombre.setText(nom);
        imagen();
    ...
    public void imagen (){
        ImageIcon img = new ImageIcon(getClass().getResource("/imagen/pelota-de-futbol.png"));
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CAIDA DE UN OBJETO");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Caida_Objeto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Caida_Objeto dialog = new Caida_Objeto(new javax.swing.JFrame(), true);
